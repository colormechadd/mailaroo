...
func LoadConfig() (*Config, error) {
	...
	viper.BindEnv("WEB.CSRF_AUTH_KEY")
	viper.BindEnv("WEB.TRUST_PROXY")
	viper.BindEnv("WEB.CERT_FILE")
	viper.BindEnv("WEB.CERT_KEY_FILE")
	viper.BindEnv("WEB.SESSION_EXPIRATION_SECONDS")
	viper.BindEnv("LOG.LEVEL")
	viper.BindEnv("LOG.FORMAT")
	viper.BindEnv("SPAM.RBL_SERVERS")
	viper.BindEnv("SPAM.RSPAMD_URL")
	viper.BindEnv("SPAM.QUARANTINE_THRESHOLD")
	viper.BindEnv("SMTP.PORTS")
	viper.BindEnv("SMTP.TLS_CERT_FILE")
	viper.BindEnv("SMTP.TLS_KEY_FILE")
	viper.BindEnv("SMTP.DOMAIN")
	viper.BindEnv("SMTP.RELAY")
	viper.BindEnv("SMTP.READ_TIMEOUT")
	viper.BindEnv("SMTP.WRITE_TIMEOUT")
	...
	viper.BindEnv("RATE_LIMIT.OUTBOUND_PER_USER_HOUR")
	viper.BindEnv("RATE_LIMIT.GREYLIST_ENABLED")
	viper.BindEnv("RATE_LIMIT.GREYLIST_DELAY")
	viper.BindEnv("DKIM.ENCRYPTION_KEY")
	viper.BindEnv("STORAGE_TYPE")
	viper.BindEnv("COMPRESSION")
	viper.BindEnv("CLASSIFIER.TYPE")
	viper.BindEnv("CLASSIFIER.API_KEY")
	viper.BindEnv("CLASSIFIER.MODEL")
	viper.BindEnv("CLASSIFIER.URL")
	viper.BindEnv("LOCAL_STORAGE.BASE_PATH")
	viper.BindEnv("S3_STORAGE.BUCKET")
	viper.BindEnv("S3_STORAGE.REGION")
	viper.BindEnv("S3_STORAGE.ENDPOINT")
	viper.BindEnv("S3_STORAGE.PREFIX")
	viper.BindEnv("GCS_STORAGE.BUCKET")
	viper.BindEnv("GCS_STORAGE.PREFIX")
