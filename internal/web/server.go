...
func (s *Server) Routes() http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/user/change-password", s.handleChangePassword)
		r.Post("/user/recovery-email", s.handleUserUpdateRecoveryEmail)
		...
		r.Group(func(r chi.Router) {
			...
			r.Post("/admin/users/{userID}/recovery-email", s.handleAdminUserSetRecoveryEmail)
