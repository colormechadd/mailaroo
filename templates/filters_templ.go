...
func FilterRulesList(mailboxID uuid.UUID, rules []*models.FilterRule) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 17, Col: 71}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 18, Col: 62}
		}
		...
		if len(rules) == 0 {
			...
			for _, rule := range rules {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 48, Col: 72}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 52, Col: 150}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 55, Col: 41}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 60, Col: 103}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 61, Col: 94}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 67, Col: 87}
				}
...
func FilterRuleForm(mailboxID uuid.UUID, rule *models.FilterRule) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 91, Col: 55}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 94, Col: 67}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 95, Col: 58}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 110, Col: 35}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 112, Col: 34}
		}
		...
		if isEdit {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 128, Col: 26}
			}
		...
		for _, opt := range filterActionOptions() {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 254, Col: 27}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 263, Col: 68}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 271, Col: 70}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/filters.templ`, Line: 272, Col: 61}
		}
...
func filterFormData(rule *models.FilterRule) string {
	if rule == nil {
		return `{ conditions: [{ field: 'from', operator: 'contains', value: '' }], addCondition() { this.conditions.push({ field: 'from', operator: 'contains', value: '' }); }, removeCondition(i) { this.conditions.splice(i, 1); } }`
	}
	conds := "["
	for i, c := range rule.Conditions {
		...
		conds += fmt.Sprintf(`{ field: '%s', operator: '%s', value: '%s' }`, c.Field, c.Operator, val)
	}
	conds += "]"
	return fmt.Sprintf(`{ conditions: %s, addCondition() { this.conditions.push({ field: 'from', operator: 'contains', value: '' }); }, removeCondition(i) { this.conditions.splice(i, 1); } }`, conds)
}
